...
Считайте рабочей памятью агента:

- `docs/local/**` (или настроенную проектом область рабочей памяти)
...
Используйте локальную рабочую память (`docs/local/**`) для:
...
Примеры, которые можно писать в `docs/local/**` без отдельного запроса:
